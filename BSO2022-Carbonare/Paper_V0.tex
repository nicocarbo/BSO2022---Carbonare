...
%---------------------------------------------------------------------------------------
The project is supported by funding from the German Federal Ministry for Economic Affairs and
Climate Action (BMWK), the Karlsruhe Institute of Technology (KIT), the Baden-Württemberg
Ministry of Food, Rural Areas and Consumer Protection, as well as cash and in-kind contributions
